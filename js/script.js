...
class Main extends Form {
  ...
  initChildrenData() {
    ...
    $(document).ready(function () {
      $("select#childGroupSelectUnder18").change(function () {
        ...
        for (let i = 0; i < $selectedChildNumber; i++) {
          ...
          auxChildrenData
            .find("#childName")
            .attr("id", "childName" + i)
            .attr("name", "childName" + i);
          auxChildrenData
            .find("#childLastName")
            .attr("id", "childLastName" + i)
            .attr("name", "childLastName" + i);
          auxChildrenData
            .find("#childBirthdate")
            .attr("id", "childBirthdate" + i)
            .attr("name", "childBirthdate" + i);
